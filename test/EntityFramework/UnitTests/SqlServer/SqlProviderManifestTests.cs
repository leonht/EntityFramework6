...
namespace System.Data.Entity.SqlServer
{
    ...
    public class SqlProviderManifestTests
    {
        ...
        [Fact]
        public void SqlCe_provider_manifest_does_not_support_parameter_optimization()
        {
            Assert.False(new SqlCeProviderManifest(false).SupportsParameterOptimizationInSchemaQueries());
        }
